...
try:
    ...
    from scripts.prompts import get_strategy
...
def generate_sql_query(client, schema_data, question: str, strategy: str = "cot") -> str:
    """
    ...
    Args:
        ...
        question: Pertanyaan dari user
        strategy: Strategi prompting ('zeroshot', 'fewshot', 'cot')
    ...
    try:
        # Get strategy
        prompt_strategy = get_strategy(strategy)
        system_prompt = prompt_strategy.get_system_prompt()
        user_prompt = prompt_strategy.get_user_prompt(schema_data, question)
